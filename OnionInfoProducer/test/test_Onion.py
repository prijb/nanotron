...
options.inputFiles = 'https://github.com/LLPDNNX/test-files/raw/master/miniaod/HNL_miniaod16v3.root'
...
process.pfOnionInfos = cms.EDProducer("OnionInfoProducer",
...
# ** nanotron comment out **
#process.pfOnionTags  = cms.EDProducer("OnionTagProducer",
#    graph_path       = cms.FileInPath("nanotron/OnionTagProducer/data/da.pb"),
#    src              = cms.InputTag("pfOnionInfos"),
