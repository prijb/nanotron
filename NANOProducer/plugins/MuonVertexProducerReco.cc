// -*- C++ -*-
//
// Package:    nanotron/MuonVertexProducerReco
// Class:      MuonVertexProducerReco
// 
/**\class MuonVertexProducerReco MuonVertexProducerReco.cc nanotron/MuonVertexProducerReco/plugins/MuonVertexProducerReco.cc
...
class MuonVertexProducerReco : public edm::stream::EDProducer<> {
   public:
      explicit MuonVertexProducerReco(const edm::ParameterSet&);
      ~MuonVertexProducerReco();
   ...
   private:
      ...
      edm::EDGetTokenT<std::vector<reco::Muon>> _muonToken;
...
//
MuonVertexProducerReco::MuonVertexProducerReco(const edm::ParameterSet& iConfig):
    _muonInputTag(iConfig.getParameter<edm::InputTag>("srcMuon")),
    _muonToken(consumes<std::vector<reco::Muon>>(_muonInputTag)),
...
MuonVertexProducerReco::~MuonVertexProducerReco()
{
...
void
MuonVertexProducerReco::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
// ------------ method called once each stream before processing any runs, lumis or events  ------------
    void
MuonVertexProducerReco::beginStream(edm::StreamID)
{
}

// ------------ method called once each stream after processing all runs, lumis and events  ------------
void
MuonVertexProducerReco::endStream() {
}

// ------------ method called when starting to processes a run  ------------
/*
   void
   MuonVertexProducerReco::beginRun(edm::Run const&, edm::EventSetup const&)
   {
   }
   */
...
/*
   void
   MuonVertexProducerReco::endRun(edm::Run const&, edm::EventSetup const&)
   {
   }
   */
...
/*
   void
   MuonVertexProducerReco::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
   {
   }
   */
...
/*
   void
   MuonVertexProducerReco::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
   {
   }
   */
...
void
MuonVertexProducerReco::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(MuonVertexProducerReco);
