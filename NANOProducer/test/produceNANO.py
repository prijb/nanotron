...
process.muonBParkTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    doc  = cms.string("finalMuons for BPark after basic selection"),
...
process.triggerObjectBParkTables = cms.Sequence(unpackedPatTrigger + process.triggerMuonTable)
...
process.llpnanoAOD_step += process.muonBParkSequence + process.muonBParkTables + process.triggerObjectBParkTables + process.muonVertexSequence
