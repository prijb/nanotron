...
process.linkedObjects = cms.EDProducer("PATObjectCrossLinker",
    jets=cms.InputTag("run3ScoutingJetToPatJet"),
    muons=cms.InputTag(""),
...
process.jetTablesTask = cms.Task(process.linkedObjects, process.jetTable)
...
if options.isData:
    ...
    process.llpnanoAOD_step_mu = cms.Path(
        process.run3ScoutingJetToPatJet,
        process.jetTablesTask
