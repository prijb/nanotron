...
class MCGhostFlavourProducer: public edm::stream::EDProducer<>
{
    ...
    private:
        ...
        const edm::EDGetTokenT<edm::View<nanotron::MCGenDecayInfo>> llpGenDecayInfoToken_;
...
MCGhostFlavourProducer::MCGhostFlavourProducer(const edm::ParameterSet& iConfig) :
...
{
    produces<edm::ValueMap<nanotron::MCGhostFlavourInfo>>();
...
MCGhostFlavourProducer::~MCGhostFlavourProducer()
{
}


void
MCGhostFlavourProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
    ...
    std::vector<nanotron::MCGhostFlavourInfo> ghostFlavourInfo(jetCollection->size());
...
void
MCGhostFlavourProducer::matchReclusteredJets(
...
void
MCGhostFlavourProducer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(MCGhostFlavourProducer);
